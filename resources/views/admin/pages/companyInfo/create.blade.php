                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="name" class="form-control" placeholder="Comppany Name..." min="1" >
                              @if ($errors->has('name'))
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea type="number" rows="10" name="description" class="form-control" placeholder="Description..."></textarea>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" name="contact1" class="form-control" placeholder="Contact 1...">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" name="contact2" class="form-control" placeholder="Contact 2...">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Enter Email</label>
                              <input type="email" name="email" class="form-control" placeholder="Email..." min="1" >
                                @if ($errors->has('email'))
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="Address" name="address" class="form-control" placeholder="Address..." min="1" >
