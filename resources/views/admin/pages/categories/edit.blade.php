...
@section('sub_title', 'Update Categories')
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-content collapse show">
                  <div class="card-body">
                    <h2 class="text-center my-1">Update Category</h2>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea type="text" name="description" rows="10" class="form-control" placeholder="Description..." required>{{ $category->description ?? '' }}</textarea>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <img src="{{ $category->image ? asset($category->image) : '' }}" alt="{{ $category->title ?? '' }}" width="150" height="150">
                          </div>
                          <div class="col-md-12">
