            ...
            <div class="col-12">
              <div class="card">
                <div class="card-content collapse show">
                  <div class="card-body">
                    <h2 class="text-center my-1">Update Loan Type</h2>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="loan_type" class="form-control" value="{{ $loan->loan_type }}" placeholder="Loan Type...">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea type="text" rows="10" name="description" class="form-control" placeholder="Description..." required>{{ $loan->description }}</textarea>
                            </div>
                          </div>
                        </div>
                      </div>
