                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="title" class="form-control" placeholder="Package Name..." required>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <label>Enter Package Description</label>
                              <textarea type="text" rows="10" name="description" class="form-control" placeholder="Package Description..."></textarea>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="repeater">
